  ...
  return (
    ...
    >
      <div className="h-full px-3 py-4 hidden md:flex flex-col bg-black dark:bg-gray-800">
        ...
        <div className="text-white border p-4 border-gray-600 rounded-xl ">
          <TypographyH4 text="Subscribe to Premium" />
          <TypographyP text="Subscribe to unlock new features and if eligible, receive a share of ads revenue." />
          <Button className="bg-[#1d9bf0] font-bold rounded-3xl mt-2 text-white p-2 w-28">
            Subscribe
          </Button>
        </div>
        <div className="border border-gray-600 rounded-xl p-4 my-5">
        ...
        <div className="border border-gray-600 p-4 rounded-xl text-white">
          <TypographyH4 text="Who to follow" />
        </div>
      </div>
    </aside>
  );
