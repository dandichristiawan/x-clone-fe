...
export const PostModal = () => {
    const { createPost, setCreatePost, Tweet, loadingPost } = useCreatePost()
    return (
        <Dialog>
            <DialogTrigger className="w-5/6 bg-[#1d9bf0] font-bold rounded-3xl mt-2 text-white p-2">Post</DialogTrigger>
