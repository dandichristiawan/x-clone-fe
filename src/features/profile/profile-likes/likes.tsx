...
import { useGetProfileLikes } from '@/hooks/user/profile.hooks';
...
export const ProfileLikesPost = ({ username }: Props) => {
  const { data, isLoading } = useGetProfileLikes(username);
              ...
              <div className="flex flex-row w-full gap-2">
                ...
                <div className="flex flex-col w-full">
                  <div className="flex flex-rw gap-2">
                    <h1 className="font-semibold">{val.user.fullname}</h1>
