...
import { Posts } from '../profile-types'
...
export const ProfilePosts = ({ username, fullName }: Props) => {
    ...
    async function getProfilePost() {
        try {
            const res = await fetch(`http://192.168.103.56:3000/api/userPost/${username}`, {
                mode: 'cors',
                method: 'GET',
                            ...
                            <div className="flex flex-row w-full gap-2">
                                ...
                                <div className="flex flex-col w-full">
                                    <div className="flex flex-rw gap-2">
                                        ...
                                        <p className='text-gray-500'>{formatDateList(val.createdAt)}</p>
                                    </div>
